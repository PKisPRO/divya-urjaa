...
export const ingredients = {
  ...
  lead: "Each Urjaa Deepak brings together cow dung, over 200 plus natural herbs and ingredients, and havan samagri — blended by hand so the burn stays true to the ritual.",
  items: [
    {
      name: "Cow Dung",
  ...
  also: "Over 200 Plus Natural Herbs and Ingredients",
  closing:
...
export const journey = {
  ...
  steps: [
    ...
    },
    {
      ...
      body: "Cow dung, over 200 plus natural herbs and ingredients, and havan samagri are blended and pressed into shape by hand — no machines, no moulds beyond a simple tray.",
