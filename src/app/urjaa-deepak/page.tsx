...
export const metadata: Metadata = {
  ...
  description:
    "₹399 per box. Each box contains 30 Urjaa Deepaks with wick, one clay diya and camphor. Handmade from cow dung, over 200 plus natural herbs and ingredients, and havan samagri by 50+ women artisans in Rajasthan.",
...
const productSchema = {
  ...
  sku: product.sku,
  description:
    "A handmade diya of cow dung, over 200 plus natural herbs and ingredients, and havan samagri, crafted by 50+ women artisans in a Rajasthan village. Each box contains 30 Urjaa Deepaks with wick, one clay diya and camphor.",
